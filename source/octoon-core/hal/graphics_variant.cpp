...
namespace octoon
{
	namespace hal
	{
		...
		void
		GraphicsVariant::setType(UniformAttributeFormat type) noexcept
		{
			if (_type != type)
			{
				if (_type == UniformAttributeFormat::IntArray)
				{
					delete _value.iarray;
					_value.iarray = nullptr;
				}
				else if (_type == UniformAttributeFormat::Int2Array)
				{
					delete _value.iarray2;
					_value.iarray2 = nullptr;
				}
				else if (_type == UniformAttributeFormat::Int3Array)
				{
					delete _value.iarray3;
					_value.iarray3 = nullptr;
				}
				else if (_type == UniformAttributeFormat::Int4Array)
				{
					delete _value.iarray4;
					_value.iarray4 = nullptr;
				}
				else if (_type == UniformAttributeFormat::UIntArray)
				{
					delete _value.uiarray;
					_value.uiarray = nullptr;
				}
				else if (_type == UniformAttributeFormat::UInt2Array)
				{
					delete _value.uiarray2;
					_value.uiarray2 = nullptr;
				}
				else if (_type == UniformAttributeFormat::UInt3Array)
				{
					delete _value.uiarray3;
					_value.uiarray3 = nullptr;
				}
				else if (_type == UniformAttributeFormat::UInt4Array)
				{
					delete _value.uiarray4;
					_value.uiarray4 = nullptr;
				}
				else if (_type == UniformAttributeFormat::FloatArray)
				{
					delete _value.farray;
					_value.farray = nullptr;
				}
				else if (_type == UniformAttributeFormat::Float2Array)
				{
					delete _value.farray2;
					_value.farray2 = nullptr;
				}
				else if (_type == UniformAttributeFormat::Float3Array)
				{
					delete _value.farray3;
					_value.farray3 = nullptr;
				}
				else if (_type == UniformAttributeFormat::Float4Array)
				{
					delete _value.farray4;
					_value.farray4 = nullptr;
				}
				else if (_type == UniformAttributeFormat::Float2x2)
				{
					delete _value.m2;
					_value.m2 = nullptr;
				}
				else if (_type == UniformAttributeFormat::Float3x3)
				{
					delete _value.m3;
					_value.m3 = nullptr;
				}
				else if (_type == UniformAttributeFormat::Float4x4)
				{
					delete _value.m4;
					_value.m4 = nullptr;
				}
				else if (_type == UniformAttributeFormat::Float2x2Array)
				{
					delete _value.m2array;
					_value.m2array = nullptr;
				}
				else if (_type == UniformAttributeFormat::Float3x3Array)
				{
					delete _value.m3array;
					_value.m3array = nullptr;
				}
				else if (_type == UniformAttributeFormat::Float4x4Array)
				{
					delete _value.m4array;
					_value.m4array = nullptr;
				}
				else if (_type == UniformAttributeFormat::UniformBuffer)
				{
					delete _value.ubo;
					_value.ubo = nullptr;
				}
				else if (_type == UniformAttributeFormat::SamplerImage ||
					_type == UniformAttributeFormat::StorageImage ||
					_type == UniformAttributeFormat::CombinedImageSampler)
				{
					if (type != UniformAttributeFormat::SamplerImage ||
						type != UniformAttributeFormat::StorageImage ||
						type != UniformAttributeFormat::CombinedImageSampler)
					{
				...
				if (type == UniformAttributeFormat::IntArray)
					_value.iarray = new std::vector<int1>();
				else if (type == UniformAttributeFormat::Int2Array)
					_value.iarray2 = new std::vector<int2>();
				else if (type == UniformAttributeFormat::Int3Array)
					_value.iarray3 = new std::vector<int3>();
				else if (type == UniformAttributeFormat::Int4Array)
					_value.iarray4 = new std::vector<int4>();
				else if (type == UniformAttributeFormat::UIntArray)
					_value.uiarray = new std::vector<uint1>();
				else if (type == UniformAttributeFormat::UInt2Array)
					_value.uiarray2 = new std::vector<uint2>();
				else if (type == UniformAttributeFormat::UInt3Array)
					_value.uiarray3 = new std::vector<uint3>();
				else if (type == UniformAttributeFormat::UInt4Array)
					_value.uiarray4 = new std::vector<uint4>();
				else if (type == UniformAttributeFormat::FloatArray)
					_value.farray = new std::vector<float1>();
				else if (type == UniformAttributeFormat::Float2Array)
					_value.farray2 = new std::vector<float2>();
				else if (type == UniformAttributeFormat::Float3Array)
					_value.farray3 = new std::vector<float3>();
				else if (type == UniformAttributeFormat::Float4Array)
					_value.farray4 = new std::vector<float4>();
				else if (type == UniformAttributeFormat::Float2x2)
					_value.m2 = new float2x2;
				else if (type == UniformAttributeFormat::Float3x3)
					_value.m3 = new float3x3;
				else if (type == UniformAttributeFormat::Float4x4)
					_value.m4 = new float4x4;
				else if (type == UniformAttributeFormat::Float3x3Array)
					_value.m3array = new std::vector<float3x3>;
				else if (type == UniformAttributeFormat::Float4x4Array)
					_value.m4array = new std::vector<float4x4>;
				else if (type == UniformAttributeFormat::UniformBuffer)
					_value.ubo = new GraphicsDataPtr;
				else if (type == UniformAttributeFormat::SamplerImage ||
					type == UniformAttributeFormat::StorageImage ||
					type == UniformAttributeFormat::CombinedImageSampler)
				{
					if (_type != UniformAttributeFormat::SamplerImage ||
						_type != UniformAttributeFormat::StorageImage ||
						_type != UniformAttributeFormat::CombinedImageSampler)
					{
		...
		{
			assert(_type == UniformAttributeFormat::Boolean);
			_value.b = b1;
		}
		...
		{
			assert(_type == UniformAttributeFormat::Int);
			_value.i[0] = i1;
		}
		...
		{
			assert(_type == UniformAttributeFormat::Int2);
			_value.i[0] = value.x;
			_value.i[1] = value.y;
		}
		...
		{
			assert(_type == UniformAttributeFormat::Int3);
			_value.i[0] = value.x;
			_value.i[1] = value.y;
			_value.i[2] = value.z;
		}
		...
		{
			assert(_type == UniformAttributeFormat::Int4);
			_value.i[0] = value.x;
			_value.i[1] = value.y;
			_value.i[2] = value.z;
			_value.i[3] = value.w;
		...
		{
			assert(_type == UniformAttributeFormat::Float);
			_value.ui[0] = ui1;
		}
		...
		{
			assert(_type == UniformAttributeFormat::UInt2);
			_value.ui[0] = value.x;
			_value.ui[1] = value.y;
		}
		...
		{
			assert(_type == UniformAttributeFormat::Float2);
			_value.ui[0] = ui1;
			_value.ui[1] = ui2;
		}
		...
		{
			assert(_type == UniformAttributeFormat::UInt3);
			_value.ui[0] = value.x;
			_value.ui[1] = value.y;
			_value.ui[2] = value.z;
		}
		...
		{
			assert(_type == UniformAttributeFormat::Float3);
			_value.ui[0] = ui1;
			_value.ui[1] = ui2;
			_value.ui[2] = ui3;
		}
		...
		{
			assert(_type == UniformAttributeFormat::UInt4);
			_value.ui[0] = value.x;
			_value.ui[1] = value.y;
			_value.ui[2] = value.z;
			_value.ui[3] = value.w;
		...
		{
			assert(_type == UniformAttributeFormat::Float4);
			_value.f[0] = value.x;
			_value.f[1] = value.y;
			_value.f[2] = value.z;
			_value.f[3] = value.w;
		...
		{
			assert(_type == UniformAttributeFormat::Float2x2);
			*_value.m2 = value;
		}
		...
		{
			assert(_type == UniformAttributeFormat::Float3x3);
			*_value.m3 = value;
		}
		...
		{
			assert(_type == UniformAttributeFormat::Float4x4);
			*_value.m4 = value;
		}
		void
		...
		{
			assert(_type == UniformAttributeFormat::IntArray);
			*_value.iarray = value;
		}
		...
		{
			assert(_type == UniformAttributeFormat::Int2Array);
		...
		{
			assert(_type == UniformAttributeFormat::Int3Array);
		...
		{
			assert(_type == UniformAttributeFormat::Int4Array);
		...
		{
			assert(_type == UniformAttributeFormat::UIntArray);
		...
		{
			assert(_type == UniformAttributeFormat::UInt2Array);
		...
		{
			assert(_type == UniformAttributeFormat::UInt3Array);
		...
		{
			assert(_type == UniformAttributeFormat::UInt4Array);
		...
		{
			assert(_type == UniformAttributeFormat::FloatArray);
			*_value.farray = value;
		}
		...
		{
			assert(_type == UniformAttributeFormat::Float2Array);
		...
		{
			assert(_type == UniformAttributeFormat::Float3Array);
		...
		{
			assert(_type == UniformAttributeFormat::Float4Array);
		...
		{
			assert(_type == UniformAttributeFormat::Float2x2Array);
		...
		{
			assert(_type == UniformAttributeFormat::Float3x3Array);
		...
		{
			assert(_type == UniformAttributeFormat::Float4x4Array);
		...
		{
			assert(_type == UniformAttributeFormat::StorageImage || _type == UniformAttributeFormat::CombinedImageSampler || _type == UniformAttributeFormat::SamplerImage);
		...
		{
			assert(_type == UniformAttributeFormat::UniformBuffer);
			*_value.ubo = ubo;
		}
		...
		{
			assert(_type == UniformAttributeFormat::UInt);
			return _value.ui[0];
		}
		...
		{
			assert(_type == UniformAttributeFormat::SamplerImage || _type == UniformAttributeFormat::StorageImage);
