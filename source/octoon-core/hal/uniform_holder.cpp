...
namespace octoon
{
	UniformHolder::UniformHolder() noexcept
		: type_(hal::UniformAttributeFormat::Null)
		, texture_(nullptr)
	{
	}
	...
	UniformHolder::~UniformHolder() noexcept
	{
		this->setType(hal::UniformAttributeFormat::Null);
	}

	void
	UniformHolder::setType(hal::UniformAttributeFormat type) noexcept(false)
	{
		if (type_ != type)
		{
			switch (type_)
			{
				case hal::UniformAttributeFormat::IntArray: { delete iarray_; iarray_ = nullptr; } break;
				case hal::UniformAttributeFormat::Int2Array: { delete iarray2_; iarray2_ = nullptr; } break;
				case hal::UniformAttributeFormat::Int3Array: { delete iarray3_; iarray3_ = nullptr; } break;
				case hal::UniformAttributeFormat::Int4Array: { delete iarray4_; iarray4_ = nullptr; } break;
				case hal::UniformAttributeFormat::UIntArray: { delete uiarray_; uiarray_ = nullptr; } break;
				case hal::UniformAttributeFormat::UInt2Array: { delete uiarray2_; uiarray2_ = nullptr; } break;
				case hal::UniformAttributeFormat::UInt3Array: { delete uiarray3_; uiarray3_ = nullptr; } break;
				case hal::UniformAttributeFormat::UInt4Array: { delete uiarray4_; uiarray4_ = nullptr; } break;
				case hal::UniformAttributeFormat::FloatArray: { delete farray_; farray_ = nullptr; } break;
				case hal::UniformAttributeFormat::Float2Array: { delete farray2_; farray2_ = nullptr; } break;
				case hal::UniformAttributeFormat::Float3Array: { delete farray3_; farray3_ = nullptr; } break;
				case hal::UniformAttributeFormat::Float4Array: { delete farray4_; farray4_ = nullptr; } break;
				case hal::UniformAttributeFormat::Float2x2: { delete m2Value_; m2Value_ = nullptr; } break;
				case hal::UniformAttributeFormat::Float3x3: { delete m3Value_; m3Value_ = nullptr; } break;
				case hal::UniformAttributeFormat::Float4x4: { delete m4Value_; m4Value_ = nullptr; } break;
				case hal::UniformAttributeFormat::Float2x2Array: { delete m2array_; m2array_ = nullptr; } break;
				case hal::UniformAttributeFormat::Float3x3Array: { delete m3array_; m3array_ = nullptr; } break;
				case hal::UniformAttributeFormat::Float4x4Array: { delete m4array_; m4array_ = nullptr; } break;
				case hal::UniformAttributeFormat::UniformBuffer: { delete ubo_; ubo_ = nullptr; } break;
				case hal::UniformAttributeFormat::SamplerImage:
				case hal::UniformAttributeFormat::StorageImage:
				case hal::UniformAttributeFormat::CombinedImageSampler:
				{
					delete texture_;
					texture_ = nullptr;
				}
			...
			switch (type)
			{
				case hal::UniformAttributeFormat::Null: { boolValue_ = false; } break;
				case hal::UniformAttributeFormat::Boolean: { boolValue_ = false; } break;
				case hal::UniformAttributeFormat::Float: { floatValue_[0] = 0; } break;
				case hal::UniformAttributeFormat::Float2: { floatValue_[0] = 0; floatValue_[1] = 0; } break;
				case hal::UniformAttributeFormat::Float3: { floatValue_[0] = 0; floatValue_[1] = 0; floatValue_[2] = 0; } break;
				case hal::UniformAttributeFormat::Float4: { floatValue_[0] = 0; floatValue_[1] = 0; floatValue_[2] = 0; floatValue_[4] = 0; } break;
				case hal::UniformAttributeFormat::Int: { intValue_[0] = 0; } break;
				case hal::UniformAttributeFormat::Int2: { intValue_[0] = 0; intValue_[1] = 0; } break;
				case hal::UniformAttributeFormat::Int3: { intValue_[0] = 0; intValue_[1] = 0; intValue_[2] = 0; } break;
				case hal::UniformAttributeFormat::Int4: { intValue_[0] = 0; intValue_[1] = 0; intValue_[2] = 0; intValue_[4] = 0; } break;
				case hal::UniformAttributeFormat::UInt: { uintValue_[0] = 0; } break;
				case hal::UniformAttributeFormat::UInt2: { uintValue_[0] = 0; uintValue_[1] = 0; } break;
				case hal::UniformAttributeFormat::UInt3: { uintValue_[0] = 0; uintValue_[1] = 0; uintValue_[2] = 0; } break;
				case hal::UniformAttributeFormat::UInt4: { uintValue_[0] = 0; uintValue_[1] = 0; uintValue_[2] = 0; uintValue_[4] = 0; } break;
				case hal::UniformAttributeFormat::IntArray: iarray_ = new std::vector<math::int1>(); break;
				case hal::UniformAttributeFormat::Int2Array: iarray2_ = new std::vector<math::int2>(); break;
				case hal::UniformAttributeFormat::Int3Array: iarray3_ = new std::vector<math::int3>(); break;
				case hal::UniformAttributeFormat::Int4Array: iarray4_ = new std::vector<math::int4>(); break;
				case hal::UniformAttributeFormat::UIntArray: uiarray_ = new std::vector<math::uint1>(); break;
				case hal::UniformAttributeFormat::UInt2Array: uiarray2_ = new std::vector<math::uint2>(); break;
				case hal::UniformAttributeFormat::UInt3Array: uiarray3_ = new std::vector<math::uint3>(); break;
				case hal::UniformAttributeFormat::UInt4Array: uiarray4_ = new std::vector<math::uint4>(); break;
				case hal::UniformAttributeFormat::FloatArray: farray_ = new std::vector<math::float1>(); break;
				case hal::UniformAttributeFormat::Float2Array: farray2_ = new std::vector<math::float2>(); break;
				case hal::UniformAttributeFormat::Float3Array: farray3_ = new std::vector<math::float3>(); break;
				case hal::UniformAttributeFormat::Float4Array: farray4_ = new std::vector<math::float4>(); break;
				case hal::UniformAttributeFormat::Float2x2: m2Value_ = new math::float2x2; break;
				case hal::UniformAttributeFormat::Float3x3: m3Value_ = new math::float3x3; break;
				case hal::UniformAttributeFormat::Float4x4: m4Value_ = new math::float4x4; break;
				case hal::UniformAttributeFormat::Float3x3Array: m3array_ = new std::vector<math::float3x3>; break;
				case hal::UniformAttributeFormat::Float4x4Array: m4array_ = new std::vector<math::float4x4>; break;
				case hal::UniformAttributeFormat::UniformBuffer: ubo_ = new hal::GraphicsDataPtr; break;
				case hal::UniformAttributeFormat::SamplerImage:
				case hal::UniformAttributeFormat::StorageImage:
				case hal::UniformAttributeFormat::CombinedImageSampler:
				{
	...
	{
		assert(type_ == hal::UniformAttributeFormat::Boolean);
		boolValue_ = b1;
	}
	...
	{
		assert(type_ == hal::UniformAttributeFormat::Int);
		intValue_[0] = i1;
	}
	...
	{
		assert(type_ == hal::UniformAttributeFormat::Int2);
		intValue_[0] = value.x;
		intValue_[1] = value.y;
	}
	...
	{
		assert(type_ == hal::UniformAttributeFormat::Int3);
		intValue_[0] = value.x;
		intValue_[1] = value.y;
		intValue_[2] = value.z;
	}
	...
	{
		assert(type_ == hal::UniformAttributeFormat::Int4);
		intValue_[0] = value.x;
		intValue_[1] = value.y;
		intValue_[2] = value.z;
		intValue_[3] = value.w;
	...
	{
		assert(type_ == hal::UniformAttributeFormat::Float);
		uintValue_[0] = ui1;
	}
	...
	{
		assert(type_ == hal::UniformAttributeFormat::UInt2);
	...
	{
		assert(type_ == hal::UniformAttributeFormat::Float2);
		uintValue_[0] = ui1;
		uintValue_[1] = ui2;
	}
	...
	{
		assert(type_ == hal::UniformAttributeFormat::UInt3);
		uintValue_[0] = value.x;
		uintValue_[1] = value.y;
	...
	{
		assert(type_ == hal::UniformAttributeFormat::Float3);
		uintValue_[0] = ui1;
		uintValue_[1] = ui2;
		uintValue_[2] = ui3;
	}
	...
	{
		assert(type_ == hal::UniformAttributeFormat::UInt4);
		uintValue_[0] = value.x;
		uintValue_[1] = value.y;
		uintValue_[2] = value.z;
	...
	{
		assert(type_ == hal::UniformAttributeFormat::Float4);
		floatValue_[0] = value.x;
		floatValue_[1] = value.y;
		floatValue_[2] = value.z;
	...
	{
		assert(type_ == hal::UniformAttributeFormat::Float2x2);
		*m2Value_ = value;
	}
	...
	{
		assert(type_ == hal::UniformAttributeFormat::Float3x3);
		*m3Value_ = value;
	}
	...
	{
		assert(type_ == hal::UniformAttributeFormat::Float4x4);
		*m4Value_ = value;
	}
	void
	...
	{
		assert(type_ == hal::UniformAttributeFormat::IntArray);
		*iarray_ = value;
	}
	...
	{
		assert(type_ == hal::UniformAttributeFormat::Int2Array);
		*iarray2_ = value;
	}
	...
	{
		assert(type_ == hal::UniformAttributeFormat::Int3Array);
		*iarray3_ = value;
	}
	...
	{
		assert(type_ == hal::UniformAttributeFormat::Int4Array);
		*iarray4_ = value;
	}
	...
	{
		assert(type_ == hal::UniformAttributeFormat::UIntArray);
		*uiarray_ = value;
	}
	...
	{
		assert(type_ == hal::UniformAttributeFormat::UInt2Array);
		*uiarray2_ = value;
	}
	...
	{
		assert(type_ == hal::UniformAttributeFormat::UInt3Array);
		*uiarray3_ = value;
	}
	...
	{
		assert(type_ == hal::UniformAttributeFormat::UInt4Array);
		*uiarray4_ = value;
	}
	...
	{
		assert(type_ == hal::UniformAttributeFormat::FloatArray);
		*farray_ = value;
	}
	...
	{
		assert(type_ == hal::UniformAttributeFormat::Float2Array);
		*farray2_ = value;
	}
	...
	{
		assert(type_ == hal::UniformAttributeFormat::Float3Array);
		*farray3_ = value;
	}
	...
	{
		assert(type_ == hal::UniformAttributeFormat::Float4Array);
		*farray4_ = value;
	}
	...
	{
		assert(type_ == hal::UniformAttributeFormat::Float2x2Array);
		*m2array_ = value;
	}
	...
	{
		assert(type_ == hal::UniformAttributeFormat::Float3x3Array);
		*m3array_ = value;
	}
	...
	{
		assert(type_ == hal::UniformAttributeFormat::Float4x4Array);
		*m4array_ = value;
	}
	...
	void
	UniformHolder::uniformTexture(std::shared_ptr<GraphicsTexture> texture, hal::GraphicsSamplerPtr sampler) noexcept
	{
		assert(type_ == hal::UniformAttributeFormat::StorageImage || type_ == hal::UniformAttributeFormat::CombinedImageSampler || type_ == hal::UniformAttributeFormat::SamplerImage);
		texture_->image = texture;
		texture_->sampler = sampler;
	}

	void
	UniformHolder::uniformBuffer(hal::GraphicsDataPtr ubo) noexcept
	{
		assert(type_ == hal::UniformAttributeFormat::UniformBuffer);
		*ubo_ = ubo;
	}
	...
	{
		assert(type_ == hal::UniformAttributeFormat::UInt);
		return uintValue_[0];
	}
	...
	{
		assert(type_ == hal::UniformAttributeFormat::SamplerImage || type_ == hal::UniformAttributeFormat::StorageImage);
		return texture_->image;
	}

	const hal::GraphicsSamplerPtr&
